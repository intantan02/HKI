...
<body class="bg">
<?php
    // Validasi pesan dari URL parameter
    if (isset($_GET['m'])) {
        $message = htmlspecialchars($_GET['m'], ENT_QUOTES, 'UTF-8');
...
<div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
    ...
    <form method="post" action="Login_Verification.php">
        ...
        <button class="w-full bg-teal-700 text-white py-2 rounded shadow hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500"
